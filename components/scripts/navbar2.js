...
if(customer_support){
  customer_support.innerHTML = `
    <div >
      ...
      <p class='text-black text-h5 mb-0'>Become an  Dealer – Where Quality and Reliability Flow Together.</p>
    </div>
    ...
    <div >
      ...
      Talk to an Expert</p>
       ...
       <div id='customer-horizontal-line'></div>
      <p class='text-black text-h5 mb-0'>Need Expert Advice? Talk to an Durity Experts  Today!</p>
    </div>
    ...
    <div >
      ...
      <div id='customer-horizontal-line'></div>
        <p class='text-black text-h5 mb-0'>Your Satisfaction, Our Priority – Contact Durity Customer Service Today!</p>
    </div>
  `
}
